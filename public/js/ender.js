/*!
  ...
  * Build: ender build qwery bonzo bean reqwest morpheus
  * =======================================================
  */
...
!function () {
  ...
  !function (window) {
    ...
    reqwest.serialize = function (form) {
      ...
      return (ender.v(inputs).chain().toArray().map(serial).value().join('') +
      ender.v(selects).chain().toArray().map(serial).value().join('') +
      ender.v(texts).chain().toArray().map(serial).value().join('')).replace(/&$/, '');
    };
